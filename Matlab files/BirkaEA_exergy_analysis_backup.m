...
for i = 1 : 4
    %% Main engines
        ...
        exergy.ME.eg_2tc(:,i) = energy.ME.eg_2tc(:,i) - ME_mfr_eg_tc.(char(ME_names(i))) .* T0 .* CP_AIR .* log(ME_T_eg.(char(ME_names(i)))(:,2) ./ T0) ;
        exergy.ME.eg_2bypass(:,i) = energy.ME.eg_2bypass(:,i) - ME_mfr_eg_bypass.(char(ME_names(i))) .* T0 .* CP_EG .* log(ME_T_eg.(char(ME_names(i)))(:,1) ./ T0) ;
        exergy.ME.eg_2(:,i) = exergy.ME.eg_2tc(:,i) + exergy.ME.eg_2bypass(:,i) ;
        if (i == 2) || (i == 3) 
    ...
    %% Auxiliary engines
        ...
        exergy.AE.eg_2tc(:,i) = energy.AE.eg_2tc(:,i) - AE_mfr_eg_tc.(char(AE_names(i))) .* T0 .* CP_AIR .* log(AE_T_eg.(char(AE_names(i)))(:,2) ./ T0) ;
        exergy.AE.eg_2bypass(:,i) = energy.AE.eg_2bypass(:,i) - AE_mfr_eg_bypass.(char(AE_names(i))) .* T0 .* CP_EG .* log(AE_T_eg.(char(AE_names(i)))(:,1) ./ T0) ;
        exergy.AE.eg_2(:,i) = exergy.AE.eg_2tc(:,i) + exergy.AE.eg_2bypass(:,i) ;
